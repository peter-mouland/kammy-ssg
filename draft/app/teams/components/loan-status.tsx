...
export const LoanStatus: React.FC<LoanStatusProps> = ({
                                                          loanedOut,
                                                          loanedIn,
                                                          gameweek
                                                      }) => {
        ...
        <div className={styles.loanStatus}>
            <h3 className={styles.title}>
                ...
                <span className={styles.loanCount}>
                    {loanedOut.length + loanedIn.length} active
                </span>
            </h3>
                ...
                <div className={styles.loanSection}>
                    <div className={styles.sectionHeader}>
                        ...
                        <div className={styles.sectionDescription}>
                            Players temporarily transferred to other teams
                        </div>
                    </div>
            ...
            {loanedIn.length > 0 && (
                <div className={styles.loanSection}>
                    <div className={styles.sectionHeader}>
                        ...
                        <div className={styles.sectionDescription}>
                            Players temporarily acquired from other teams
                        </div>
                    </div>
            ...
            <div className={styles.loanInfo}>
                ...
                <div className={styles.infoText}>
                    Loan transfers allow temporary player exchanges between teams.
                    Loaned players contribute points to their temporary team but return
                    to their original team at the end of the loan period.
                </div>
            </div>
        </div>
    );
