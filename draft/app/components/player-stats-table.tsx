                ...
                <table className={styles.table}>
                    ...
                    {filteredPlayers.map((player) =>  (
                        <tr key={player.id} className={styles.playerRow}>
                            ...
                            <td className={styles.stat}>{player.draft.pointsBreakdown.appearance.stat}</td>
                            <td className={styles.stat}>{player.draft.pointsBreakdown.goals.stat}</td>
                            <td className={styles.stat}>{player.draft.pointsBreakdown.assists.stat}</td>
                            <td className={styles.stat}>{formatStatValue(player.draft.pointsBreakdown.cleanSheets.stat, 'clean_sheets', player.draft.position)}</td>
                            <td className={styles.stat}>{formatStatValue(player.draft.pointsBreakdown.goalsConceded?.stat, 'goals_conceded', player.draft.position)}</td>
                            <td className={styles.stat}>{formatStatValue(player.draft.pointsBreakdown.penaltiesSaved?.stat, 'penalties_saved', player.draft.position)}</td>
                            <td className={styles.stat}>{player.draft.pointsBreakdown.yellowCards.stat}</td>
                            <td className={styles.stat}>{player.draft.pointsBreakdown.redCards.stat}</td>
                            <td className={styles.stat}>{formatStatValue(player.draft.pointsBreakdown.bonus?.stat, 'bonus', player.draft.position)}</td>
                            <td className={styles.stat}>{formatStatValue(player.draft.pointsBreakdown.saves?.stat, 'saves', player.draft.position)}</td>
