...
module.exports = [
    ...
    {
        name: 'leagueTwo-teams',
        exact: true,
        path: '/league-two/teams',
        meta: {
            title: 'Draft - League Two Teams',
            description: 'Draft : Fantasy Football',
        },
        props: {
            divisionId: 'leagueTwo',
            label: 'League Two: Teams',
        },
        label: 'Teams',
        requiresAuthentication: false,
        component: 'TeamsPage',
