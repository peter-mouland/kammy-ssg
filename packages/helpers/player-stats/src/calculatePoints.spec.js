/* eslint-env jest */
const { forTackleBonus, forStarting, forSub, forAssists, forYellowCards, forRedCards, forGoals, forSaveBonus, forCleanSheet, forConceded, calculateTotalPoints, forPenaltiesSaved } = require('./calculatePoints');
