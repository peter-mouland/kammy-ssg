...
describe('field-sorter', () => {
    describe('without overrides', () => {
        it('should sort by a single field', () => {
            const arr = [{ name: 'z' }, { name: 'x' }, { name: 'a' }];
            expect(arr.sort(sortColumns(['name']))).toEqual([{ name: 'a' }, { name: 'x' }, { name: 'z' }]);
        });
    ...
    describe('with overrides will order the overridden column with the supplied order', () => {
        ...
        it('should sort by multiple fields and override both', () => {
            ...
            expect(
                arr.sort(sortColumns(['name', 'surname'], { name: ['x', 'z', 'a'], surname: ['zxy', 'abc'] })),
            ).toEqual([
                { name: 'z', surname: 'zxy' },
                { name: 'z', surname: 'abc' },
                { name: 'a', surname: 'b' },
        ...
        it('should sort by multiple sub-fields', () => {
            ...
            expect(
                arr.sort(sortColumns(['name.forename', 'name.surname'], { 'name.forename': ['x', 'z', 'a'] })),
            ).toEqual([
                { name: { forename: 'z', surname: 'abc' } },
                { name: { forename: 'z', surname: 'zxy' } },
                { name: { forename: 'a', surname: 'b' } },
        ...
        it('should sort by multiple sub-fields with multiple overrides', () => {
            ...
            expect(
                arr.sort(
                    sortColumns(['name.forename', 'name.surname'], {
                        'name.forename': ['x', 'z', 'a'],
                        'name.surname': ['b', 'zxy', 'abc'],
                    }),
                ),
            ).toEqual([
                { name: { forename: 'z', surname: 'zxy' } },
